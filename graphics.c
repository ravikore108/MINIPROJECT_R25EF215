...
void modify_object(int id) {
    for (int i = 0; i < obj_count; i++) {
        ...
        switch (o->type) {
            case LINE:
                printf("New start row col points: "); scanf("%d %d",&o->y1,&o->x1);
                printf("New end   row col points: "); scanf("%d %d",&o->y2,&o->x2);
                break;
            case RECT:
                printf("New top-left  row col points: "); scanf("%d %d",&o->y1,&o->x1);
                printf("New bot-right row col points: "); scanf("%d %d",&o->y2,&o->x2);
                break;
            case CIRCLE:
                printf("New center row col points: "); scanf("%d %d",&o->y1,&o->x1);
                printf("New radius: ");         scanf("%d",&o->r);
                break;
            case TRIANGLE:
                printf("New V1 row col points: "); scanf("%d %d",&o->y1,&o->x1);
                printf("New V2 row col points: "); scanf("%d %d",&o->y2,&o->x2);
                printf("New V3 row col points: "); scanf("%d %d",&o->y3,&o->x3);
                break;
        }
...
void add_menu() {
    ...
    switch(c) {
        ...
        case 2:
            o.type = RECT;
            printf("Top-left  row col points: "); scanf("%d %d",&o.y1,&o.x1);
            printf("Bot-right row col points: "); scanf("%d %d",&o.y2,&o.x2);
            break;
        case 3:
            o.type = CIRCLE;
            printf("Center row col points: "); scanf("%d %d",&o.y1,&o.x1);
            printf("Radius: ");         scanf("%d",&o.r);
            break;
        case 4:
            o.type = TRIANGLE;
            printf("Vertice1 row col points: "); scanf("%d %d",&o.y1,&o.x1);
            printf("Vertice2 row col points: "); scanf("%d %d",&o.y2,&o.x2);
            printf("Vertice3 row col points: "); scanf("%d %d",&o.y3,&o.x3);
            break;
